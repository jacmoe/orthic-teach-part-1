...
The source code is hosted at [[https://github.com/jacmoe/orthic-teach-part-1]]. New versions of this document is available at that address, and should you find errors in the text, it would be greatly appreciated if you reported it there.
