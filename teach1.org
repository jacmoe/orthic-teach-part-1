...
X /aso/ = /also/, X /ea/ = /each/, X /ay/ = /any/. X is /because/, therefore X = /cause/. X being /child/, X = /children/. X = /from/, show clearly that X being /for/, X is _form_, not /from/. X = /great/, X = /much/ (/ch/ curled inside), X = /that/ (/th/ left out and /t/ written above the line), X = /already/, X = /acing/ = /according/, X = /after/, X = /bth/ = /both/, X /el/ = /else/, X /een/ = /even/, X = /except/, X /lp/ = /help/, X /kn/ = /know/, X /lile/ = /little/, X /ler/ = /letter/, X /pt/ = /part/, X /s/ = /sir/, X /rk/ = /work/, X = /word/, X = both /would/ and /world/.

** Conclusion
Point out that words similar to those given above can be treated in the same way as /such/ like /much/; /party/ X, etc.
#+begin_export LaTeX
\pagebreak
#+end_export
* Lesson 6
...
#  LocalWords:  for’ard bigskip ount
