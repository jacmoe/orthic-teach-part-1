...
*** Th
Use mode 1 _only when initial_, except in the case of the word /although/ X
*** Eve (vowel V vowel)
It is clear that the shorthand characters /eve/ X must throw everything following the final /e/ above the line, and it is also evident that such words cannot clash with that peculiarity of the English language /Th/, except in the words /even/ and /then/, which has been provided for above.

Therefore apply the rule /Mode 1/, and _wherever_ /vowel v vowel/ come, _in any part of a word_, leave them out, and write the rest of the word _above_ the line, just where it would have come had the whole word been written. E.g. X = X /given/, X /loved/. N.B. It is better to write the vowel after /l/ and /r/ for reasons similar to those given in Lesson 4, to show the direction in which the consonants are turned. X = /evident/, X = /conceived/, X = /ever/. See paragraph 2, Lesson 4.

But how about a word ending in /ave/, /ove/, etc. only? What is Euclid’s definition of the end of straight lines? A point, is it not? Shorthand /e/ X is a straight line; the end of that straight line X is a point; therefore write the point. Thus X /give/, X /love/, X /rove/.
** Be
As there is a very close relation between /V/ and /B/, and as words with the prefix “be” belong to a special English class, we may without fear use /Mode 1/ to indicate the _prefix_ “Be”. This abbreviation is only to be used when “be” is a distinct prefix, as X = /behold/; it would be incorrect to write X for /bead/, this would be /Be-ad/, not /bead/. By the same reasoning as the _dot_ indicating /vowel-v-vowel/ so the verb “be” may be shown by a dot; thus X; the only liberty taken in using this prefix “be” is in the common words _been_, _better_, _best_, and _by_ which are written X, respectively.

X = /bring/, compare crooked /ing/ X for /thing/.
